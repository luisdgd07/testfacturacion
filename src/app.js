...
facturacionelectronicapy_xmlgen_1["default"].generateXMLDE(params1, data).then(function (xml) {
    //console.log(xml);
    facturacionelectronicapy_xmlsign_1["default"]
        .signXML(xml, '/Users/oscar/Documents/node-server/certs/3997053.pfx', 'Die1905982022')
        ...
        facturacionelectronicapy_qrgen_1["default"]
            ...
            facturacionelectronicapy_setapi_1["default"]
                .recibe(1, xmlQR, "test", "/Users/oscar/Documents/node-server/certs/3997053.pfx", "Die1905982022")
